...
import static fuzs.mindfuldarkness.common.client.util.CompactConversionsUtil.*;
import static fuzs.mindfuldarkness.common.client.util.HSPConversionUtil.HSPtoRGB;
import static fuzs.mindfuldarkness.common.client.util.HSPConversionUtil.RGBtoHSP;
