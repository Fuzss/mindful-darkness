package fuzs.mindfuldarkness.common.client.gui.screens;

import fuzs.mindfuldarkness.common.MindfulDarkness;
import fuzs.mindfuldarkness.common.client.gui.components.FlatTextureButton;
import fuzs.mindfuldarkness.common.client.gui.components.FlatTextureSliderButton;
import fuzs.mindfuldarkness.common.client.handler.ColorChangedAssetsManager;
...
public class PixelConfigScreen extends Screen {
    ...
    protected void init() {
        ...
        this.addRenderableWidget(new FlatTextureButton(this.leftPos + 13,
                this.topPos + 32,
                150,
                20,
        ...
        this.addRenderableWidget(new FlatTextureSliderButton(this.leftPos + 13,
                        this.topPos + 81,
                        150,
                        18,
